...
export default function useTempHumData() {
  ...
  useEffect(() => {
    const latestRef = ref(db, 'TempnHumData/latest');
    const historyRef = ref(db, 'TempnHumData/history');
    const analysisRef = ref(db, 'TempnHumData/analysis');
